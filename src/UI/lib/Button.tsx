...
export const Button: Component<ButtonProps> = (props) => {
    ...
    const baseClass = "h-10 px-6 rounded-full text-sm font-medium transition-colors duration-200 flex items-center justify-center cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed";
