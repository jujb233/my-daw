...
export const IconButton: Component<IconButtonProps> = props => {
    ...
    const baseClass =
        'h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed'
    ...
    const variants = {
        ...
        outlined:
            'border border-outline text-on-surface-variant hover:bg-on-surface-variant/10 active:bg-on-surface-variant/20',
        standard:
