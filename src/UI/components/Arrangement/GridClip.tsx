...
export const GridClip: Component<GridClipProps> = (props) => {
    return (
        <div
            class="absolute h-full rounded border border-black/20 overflow-hidden cursor-pointer hover:brightness-110 transition-all group"
            style={{
        ...
        >
            <div class="px-2 py-1 text-xs font-medium text-white truncate select-none">
                {props.name}
            </div>
