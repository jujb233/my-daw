    ...
    return (
        <div class="w-28 bg-surface-container-low border-r border-outline-variant flex flex-col items-center py-3 gap-3 shrink-0 select-none">
            ...
            <div class="w-full px-2 text-center">
                <span class="text-sm font-medium text-on-surface truncate block" title={props.track.label}>
                    {props.track.label}
                </span>
            </div>
            ...
            <div class="flex gap-2 w-full justify-center px-2">
                <button
                    title={t('icons.mute')}
                    class={`flex-1 h-10 text-xs font-bold rounded transition-colors ${props.track.mute
                ...
                <button
                    title={t('icons.solo')}
                    class={`flex-1 h-10 text-xs font-bold rounded transition-colors ${props.track.solo
