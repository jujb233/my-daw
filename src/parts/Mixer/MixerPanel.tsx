...
export const MixerPanel: Component = () => {
    ...
    return (
        ...
        >
            ...
            <div
                class={`h-full w-12 flex flex-col items-center pt-4 gap-4 ${isOpen() ? 'hidden' : 'flex'}`}
            >
                <span
                    class='writing-vertical-rl text-on-surface font-medium tracking-widest select-none'
            ...
            <div class={`flex-1 flex flex-col overflow-hidden ${isOpen() ? 'flex' : 'hidden'}`}>
                <div class='h-10 border-b border-outline-variant flex items-center justify-between px-4 bg-surface-container shrink-0'>
                    ...
                    <div class='flex gap-2'>
                        {/* Maximize Button */}
                        <IconButton
                            onClick={() => setWidth(window.innerWidth - 350)}
                            variant='standard'
                            class='w-8 h-8'
                            title='Maximize'
                        >
                            <svg
                                ...
                                fill='currentColor'
                            >
                                <path d='M120-120v-320h80v184l504-504H520v-80h320v320h-80v-184L256-120H120Z' />
                            </svg>
                        </IconButton>
