        ...
        return (
                ...
                >
                        <div class='mr-4 flex shrink-0 items-center gap-2'>
                                ...
                                <IconButton variant='filled' onClick={togglePlayback} class='h-12 w-12 !rounded-full'>
                        ...
                        <div class='flex shrink-0 gap-6 md:gap-8'>
                                ...
                                <div class='flex min-w-[60px] flex-col'>
                                        ...
                                        <span class='text-primary font-mono text-xl whitespace-nowrap'>
                                                {store.playback.currentPosition.bar}.
                                                {store.playback.currentPosition.beat}
                                        </span>
                                </div>
                                <div class='flex min-w-[60px] flex-col'>
                                ...
                                <div class='flex min-w-[60px] flex-col'>
                                        ...
                                        <span class='text-primary font-mono text-xl whitespace-nowrap'>
                                                {store.info.timeSignature.numerator}/
                                                {store.info.timeSignature.denominator}
                                        </span>
                                </div>
                        </div>
                </Surface>
